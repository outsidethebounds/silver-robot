...
import { discountedPrice, getDisplaySize, groupByCategory, itemSearchText } from '../utils';
import ProductCard from './ProductCard';

const sortItems = (items, option) => {
  const sorted = [...items];
  if (option === 'Alphabetical') sorted.sort((a, b) => a.name.localeCompare(b.name));
  if (option === 'Price: Low to High') sorted.sort((a, b) => discountedPrice(a.listPrice, a.discount) - discountedPrice(b.listPrice, b.discount));
  if (option === 'Price: High to Low') sorted.sort((a, b) => discountedPrice(b.listPrice, b.discount) - discountedPrice(a.listPrice, a.discount));
